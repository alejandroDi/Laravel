                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" v-model="rfc" placeholder="Rfc de usuario">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" v-model="direccion" placeholder="Direccion de usuario">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" v-model="telefono" placeholder="Telefono de usuario">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idrol">
                                            <option value="0">sleccione un rol</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="number-input">Usuario(*)</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" v-model="usuario" placeholder="Nombre de usuario">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="number-input">Password(*)</label>
                                    <div class="col-md-9">
                                        <input type="password" class="form-control" v-model="password" placeholder="Password de acceso">
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            ...
            validarPersona(){
                ...
                if(!this.usuario)  this.errorMostrarMsjPersona.push("el usuario no debe estar vacio.");
                if(!this.password)  this.errorMostrarMsjPersona.push("el password no debe estar vacio.");
                if(this.idrol==0)  this.errorMostrarMsjPersona.push("Debes seleccionar un rol.");
