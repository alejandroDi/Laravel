            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Chofers
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" v-model="rfc" placeholder="Rfc de chofer">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" v-model="nombre" placeholder="Nombre de chofer">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" v-model="direccion" placeholder="Direccion de chofer">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" v-model="telefono" placeholder="Telefono de chofer">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="number-input">vehiculo(*)</label>
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idvehiculo">
                                            <option value="0">sleccione una placa</option>

                                            <option v-for="vehiculo in arrayVehiculo" :key="vehiculo.id" :value="vehiculo.id" v-text="vehiculo.placas"></option>
                                        </select>
                                         <span>no se aceptan placas en uso de otro conductor</span>
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            listarPersona(page,buscar,criterio){
                let me=this;
                var url='/chofer?page='+ page + '&buscar=' + buscar + '&criterio=' + criterio; 
            ...
            selectVehiculo(){
                let me=this;
                var url='/vehiculo/selectVehiculo'; 
                axios.get(url).then(function (response) {
                        var respuesta=response.data;
            ...
            desactivarPersona(id){
                ...
                title: 'Esta seguro de desactivar este chofer?',
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    swalWithBootstrapButtons(
                    'Desactivado!',
                    'El chofer ha sido desactivado con éxito.',
                    'success'
                    )
                }).catch(function(error){
                    console.log(error);
             ...
             activarPersona(id){
                ...
                swalWithBootstrapButtons({
                title: 'Esta seguro de activar este chofer?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Aceptar!',
                cancelButtonText: 'Cancelar!',
                ...
                if (result.value) {
                    ...
                    swalWithBootstrapButtons(
                    'Activado!',
                    'El chofer ha sido activado con éxito.',
                    'success'
                    )
                }).catch(function(error){
                    console.log(error);
            ...
            validarPersona(){
                ...
                if(this.idvehiculo==0)  this.errorMostrarMsjPersona.push("Debes seleccionar una placa.");
                ...
                switch(modelo){
                    case "persona":
                    {
                        switch(accion){
                            case 'registrar':
                            {
                                this.tituloModal='Registrar Chofer';
                                 this.errorPersona=0;
                                this.modal=1;
                                this.rfc='';
                                this.nombre='';
                            ...
                            case 'actualizar':
                            {
                               ...
                               this.errorPersona=0;
                               this.modal=1;
                               this.tituloModal='Actualizar Chofer';
                               this.tipoAccion=2;
