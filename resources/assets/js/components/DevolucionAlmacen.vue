                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="devolucion in arrayDevolucion" :key="devolucion.id">
                                        ...
                                        <template v-if="devolucion.status">
                                            <button type="button" class="btn btn-danger btn-sm " @click="desactivarDevolucion(devolucion.id)">
                                            <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else="">
                                            <button type="button" class="btn btn-info btn-sm " @click="activarDevolucion(devolucion.id)">
        ...
        methods : {
            ...
            verDevolucion(id){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.servicio=arrayDevolucionT[0]['id'];
            ...
            desactivarDevolucion(id){
                ...
                title: 'Esta seguro de desactivar este Devolucion?',
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    axios.put('/devolucion/desactivar',{
                    'id':id
                }).then(function(response){
                    me.listarDevolucion(1,'','id');
             ...
             activarDevolucion(id){
                ...
                swalWithBootstrapButtons({
                title: 'Esta seguro de activar este Devolucion?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Aceptar!',
                cancelButtonText: 'Cancelar!',
